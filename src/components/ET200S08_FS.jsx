  ...
  return (
    <div className="cursor-default">
      <Tooltip tooltip={tooltip}>
        <span
          className="absolute h-[18px] w-[68px] bg-yellow-300 border-b border-slate-100 pl-1 text-left text-[0.65rem] text-slate-950"
          id={"id-".concat(nr, bit)}
        >
          {label}
        </span>
...
function Byte({ byte, nr }) {
  ...
  return (
    <div>
      <span
        className="absolute bg-[#c0dcec] h-[16px] w-[68px] flex items-center justify-center text-xs text-blue-500"
        id={"label-" + nr}
      >
        {label}
      </span>
